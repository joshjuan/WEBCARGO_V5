...
/**
 * DevicesReportsSearch represents the model behind the search form of `frontend\models\DevicesReports`.
 */
class DevicesReportsSearch extends DevicesReports
{
    ...
    {
        return [
            [['id', 'received_from', 'received_to', 'border_port', 'gate_number', 'received_from_staff', 'received_status', 'received_by', 'created_by', 'branch', 'type', 'device_category', 'released_by', 'released_to', 'transferred_from', 'transferred_to', 'transferred_by', 'sales_person', 'sale_id', 'view_status', 'registration_by'], 'integer'],
