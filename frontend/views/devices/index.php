        ...
        [
            ...
            'value' => function ($model) {
                if ($model->view_status == Devices::registration) {
                    ...
                    return "Damaged";
                } else if ($model->view_status == Devices::border_received) {
...
//        ],
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            ...
            'before' =>Yii::$app->user->can('processDevicesToAccounts') ? Html::submitButton('<i class="fa fa-check"></i> Send to Accounts', ['class' => 'btn btn-success', 'data' => [
                'confirm' => Yii::t('app', 'Are you sure you want to sent to accounts ?'),
                'method' => 'post',
            ],]) : '',
        ],
