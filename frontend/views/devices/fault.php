...
<div class="received-devices-index" style="padding-top: 2%">
    ...
    ?>
    <?php echo $this->render('_searchFault', ['model' => $searchModel]); ?>

    <div style="padding-top: 10px; padding-bottom: 10px">
        <?php if (Yii::$app->user->can('faultToAwaitingStorage')) { ?>
            <?= Html::beginForm(['devices/fault-to-await-storage'], 'post'); ?>
            <?= Html::dropDownList('action', '', ['' => 'Select Option: ', '1' => 'Send to Await Storage', '2' => 'Send to Damaged'], ['class' => 'dropdown', 'style' => ['height' => '33px']]) ?>
...
//        ],
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => 'List of Devices serial numbers in maintenance',
...
//            ],]),
        ...
        'exportConfig' => [
            GridView::EXCEL => [
                'filename' => Yii::t('app', 'fault device-') . date('Y-m-d'),
                'showPageSummary' => true,
                'options' => [
                    'title' => 'Custom Title',
                    'subject' => 'PDF export',
