...
<div class="received-devices-index" style="padding-top: 2%">
    ...
    ?>
    <?php echo $this->render('_searchStore', ['model' => $searchModel]); ?>
    <?php
    //Html::beginForm(['awaiting-to-store'], 'post'); ?>

    <div style="padding-top: 10px; padding-bottom: 10px">
        <?php if (Yii::$app->user->can('storeToAwaitAllocation')) { ?>
            <?= Html::beginForm(['devices/store-to-await-allocation'], 'post'); ?>
            <?= Html::dropDownList('action', '', ['' => 'Select Option: ', '1' => 'Send to Await Allocation', '2' => 'Send to Await Storage'], ['class' => 'dropdown', 'style' => ['height' => '33px']]) ?>
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => 'List of Devices serial numbers in Store',
...
//            ],]),
        ...
        'exportConfig' => [
            GridView::EXCEL => [
                'filename' => Yii::t('app', 'storage device-') . date('Y-m-d'),
                'showPageSummary' => true,
                'options' => [
                    'title' => 'Custom Title',
                    'subject' => 'PDF export',
