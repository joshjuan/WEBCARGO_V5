...
<div class="received-devices-index" style="padding-top: 2%">
    ...
    <?=  Html::dropDownList("action","",ArrayHelper::map(\backend\models\User::find()->where(['user_type'=>\backend\models\User::PORT_STAFF])->all(),'id','username'),['prompt' => '--- Sales Person ---','style'=>['height'=>'40px']]) ; ?>
