...
<div class="received-devices-index" style="padding-top: 2%">
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            ...
            'before' => Yii::$app->user->can('onRoadToBorderReturn') ? Html::submitButton('<i class="fa fa-check"></i>Send to Border Received', ['class' => 'btn btn-success', 'data' => [
