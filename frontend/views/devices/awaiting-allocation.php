...
<div class="received-devices-index" style="padding-top: 2%">
    ...
    <?php if (Yii::$app->user->can('AllocateDevices')) { ?>
        <?= Html::beginForm(['devices/allocate-device'], 'post'); ?>
        <?php
...
//        ],
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => 'List of devices awaiting Allocation',
        ...
        'exportConfig' => [
            GridView::EXCEL => [
                'filename' => Yii::t('app', 'await-allocation Devices-') . date('Y-m-d'),
                'showPageSummary' => true,
                'options' => [
                    'title' => 'Custom Title',
                    'subject' => 'PDF export',
