...
/**
 * ReceivedDevicesSearch represents the model behind the search form of `frontend\models\ReceivedDevices`.
 */
class ReceivedDevicesSearch extends ReceivedDevices
{
    ...
    public function search($params)
    {
        ...
        if (\Yii::$app->user->identity->user_type == User::PARTNER) {
            ...
            $query->andFilterWhere(['like', 'remark', $this->remark]);// $query->andFilterWhere(['=', 'view_status', $this->view_status]);
            return $dataProvider;
        }
        else {
            $query = ReceivedDevices::find();
