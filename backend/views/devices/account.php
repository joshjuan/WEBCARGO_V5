...
//        ],
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            ...
            'before' => Html::submitButton('<i class="fa fa-check"></i> Send to Await Storage', ['class' => 'btn btn-success', 'data' => [
                'confirm' => Yii::t('app', 'Are you sure you want to send to await storage ?'),
                'method' => 'post',
            ],]),
        ],
