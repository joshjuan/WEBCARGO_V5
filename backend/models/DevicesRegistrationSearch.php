...
/**
 * DevicesRegistrationSearch represents the model behind the search form of `backend\models\DevicesRegistration`.
 */
class DevicesRegistrationSearch extends DevicesRegistration
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return [
            [['id', 'received_from', 'border_port', 'received_from_staff', 'received_status', 'received_by', 'created_by', 'device_from', 'stock_status', 'status', 'branch', 'type', 'device_category', 'released_by', 'released_to', 'transferred_from', 'transferred_to', 'transferred_by', 'sales_person', 'sale_id', 'view_status', 'partiner', 'registration_by'], 'integer'],
            [['serial_no', 'sim_card', 'received_at', 'remark', 'created_at', 'transferred_date', 'released_date', 'tzl', 'vehicle_no', 'container_number', 'registration_date'], 'safe'],
        ];
    }
    ...
    {
        $query = DevicesRegistration::find();
