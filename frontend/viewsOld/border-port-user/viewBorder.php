...
<div class="border-port-user-view">
    <div class="row" style="padding-top: 3%">
        ...
        <div class="col-md-6">
            ...
            <?php if (Yii::$app->user->can('admin') || Yii::$app->user->can('addUserAllocated')) { ?>
                <?= Html::a(Yii::t('app', '<i class="fa fa-user"></i>Add New'), ['create-border'], ['class' => 'btn btn-primary waves-effect waves-light']) ?>
            <?php } ?>
            <?= Html::a(Yii::t('app', '<i class="fa fa-th-list"></i> User Allocated List'), ['border'], ['class' => 'btn btn-primary waves-effect waves-light']) ?>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <p>
                <?php if (Yii::$app->user->can('admin') || Yii::$app->user->can('addUserAllocated')) { ?>
                    <?= Html::a('Update', ['update-border', 'id' => $model->id], ['class' => 'btn btn-primary']) ?>
                <?php } ?>
                <?= Html::a(Yii::t('app', 'Cancel'), ['border',], ['class' => 'btn btn-warning']) ?>
