        ...
        <div id="collapse1" class="panel-collapse collapse">
            <div class="panel panel-body" style="background: #EEE">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?= $form->field($model, 'released_by')->dropDownList(\frontend\models\User::getStaff(), ['prompt' => 'Select user ----']) ?>
                    </div>
                    <div class="col-md-4">
                        <?= $form->field($model, 'released_to')->dropDownList(\frontend\models\User::getStaff(), ['prompt' => 'Select user ----']) ?>
                    </div>

                    <div class="col-md-4">
                        <?= $form->field($model, 'transferred_from')->dropDownList(\frontend\models\User::getAllUser(), ['prompt' => 'Select user ----']) ?>
                    </div>

                    <div class="col-md-4">
                        <?= $form->field($model, 'transferred_to')->dropDownList(\frontend\models\User::getAllUser(), ['prompt' => 'Select user ----']) ?>
                    </div>
