...
<div class="received-devices-index" style="padding-top: 2%">
    ...
    ?>
    <?php echo $this->render('_searchBorderReturn', ['model' => $searchModel]); ?>
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => 'List of devices In border return(Return to office)',
        ...
        'exportConfig' => [
            GridView::EXCEL => [
                'filename' => Yii::t('app', 'borderreturn report-') . date('Y-m-d'),
                'showPageSummary' => true,
                'options' => [
                    'title' => 'Custom Title',
                    'subject' => 'PDF export',
