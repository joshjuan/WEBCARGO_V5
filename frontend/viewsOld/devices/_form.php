    ...
    <div class="col-sm-12 no-padding">
        ...
        <div class="col-sm-4" style="padding-top: 1%">
            <?= $form->field($model, 'branch')->dropDownList(
                \frontend\models\Branches::getAllBranches(),           // Flat array ('id'=>'label')
        ...
        <div class="col-sm-12 no-padding">
            <div class="col-sm-4">
                <?= $form->field($model, 'received_from')->dropDownList(
        ...
        <div class="col-sm-12 no-padding">
            <div class="col-sm-4">
                <?= $form->field($model, 'partiner')->dropDownList([1=>'Partner 1'],[ 'prompt'=>'Select Partner']) ?>
            </div>
        </div>
