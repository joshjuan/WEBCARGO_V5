    ...
    <div class="<?php echo $model->isNewRecord ? 'box-success' : 'box-info'; ?> box view-item col-xs-12 col-lg-12">
        <div class="auth-assignment-form">
            ...
            <div class="col-sm-12 no-padding">
                <div class="col-sm-6">
                    <?= $form->field($model, 'item_name')->dropDownList(\frontend\models\AuthItem::getAll(),['prompt'=>'-- Select Item --']) ?>
                </div>
            </div>
            <div class="col-sm-12 no-padding">
                <div class="col-sm-6">
                    <?= $form->field($model, 'user_id')->dropDownList(\frontend\models\User::getAll(),['prompt'=>'-- Select user --']) ?>
                </div>
            </div>
