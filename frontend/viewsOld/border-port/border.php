...
/* @var $searchModel frontend\models\BorderPortSearch */
...
<div class="border-port-index" style="padding-top: 3%">
    ...
    <div class="row">
        <div class="col-md-6">
            <strong class="lead"  style="color: #01214d;font-family: Tahoma"> <i class="fa fa-check-square text-green"></i> ECTS Portal - BORDER LIST</strong>
        </div>

        <div class="col-md-6">
            <?php if (Yii::$app->user->can('admin')||Yii::$app->user->can('addBorder')) { ?>
            <?= Html::a(Yii::t('app', '<i class="fa fa-map-marker"></i> Add New'), ['create-border'], ['class' => 'btn btn-primary waves-effect waves-light']) ?>
            <?php } ?>
