...
/**
 * AuditSearch represents the model behind the search form about `frontend\models\Audit`.
 */
class AuditSearch extends Audit
{
    ...
    {
        $dataUser=User::find()->select(['username'])->where(['=','branch',Yii::$app->user->identity->branch])->asArray();
