...
$this->title = '';
$this->params['breadcrumbs'][] = 'Border Users Allocation';
?>
    ...
    <div class="row">
        <div class="col-md-6">
            <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i
                        class="fa fa-check-square text-green"></i> ECTS Portal - BORDER USER ALLOCATION</strong>
        </div>

        <div class="col-md-6">
            <?php if (Yii::$app->user->can('assignUserBorder')) { ?>
