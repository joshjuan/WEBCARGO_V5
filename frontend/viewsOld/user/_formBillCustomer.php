                ...
                <div class="col-xs-12 col-lg-12 col-sm-12">
                    <div class="col-sm-12 no-padding">
                        ...
                        <div class="col-sm-6">
                            ...
                            <?= $form->field($model, 'username')->textInput(['class'=>'form-control', 'placeholder'=>'Login name'])->label('Login name',['class'=>'label-class',]) ?>
                        </div>
                    </div>
                    <div class="col-sm-12 no-padding">
                        <div class="col-sm-6">
                    ...
                    <div class="col-sm-12 no-padding">
                        ...
                        <div class="col-sm-3">
                            <?= $form->field($model, 'branch')->dropDownList(\backend\models\Branches::getAllBranches(),  ['prompt' => '-- select Branch name --']) ?>

                        </div>
                        <div class="col-sm-3">
                            <?= $form->field($model, 'role')->dropDownList(\frontend\models\User::getRulesBillCustomerRules(),  ['prompt' => '-- select role name --']) ?>
