        ...
        <div id="collapse1" class="panel-collapse collapse">
            <div class="panel panel-body" style="background: #EEE">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <?= $form->field($model, 'released_by')->dropDownList(\backend\models\User::getAllUser(), ['prompt' => 'Select user ----']) ?>
                    </div>
                    <div class="col-md-4">
                        <?= $form->field($model, 'released_to')->dropDownList(\backend\models\User::getPortUser(), ['prompt' => 'Select user ----']) ?>
                    </div>

                    <div class="col-md-4">
                        <?= $form->field($model, 'transferred_from')->dropDownList(\backend\models\User::getAllUser(), ['prompt' => 'Select user ----']) ?>
                    </div>

                    <div class="col-md-4">
                        <?= $form->field($model, 'transferred_to')->dropDownList(\backend\models\User::getAllUser(), ['prompt' => 'Select user ----']) ?>
                    </div>
