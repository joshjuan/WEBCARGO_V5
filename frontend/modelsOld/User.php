...
class User extends \common\models\User
{
    ...
    {
        return [
            [['username','role','mobile','user_type', 'created_at','auth_key','password_hash','password_reset_token','email'], 'required',],
            [['status', 'branch', 'created_at', 'updated_at','user_type'], 'integer'],
    ...
    {
        return [
            'default' => ['full_name','username','user_type','company_name','email','role','password','repassword', 'status',],
    ...
    public static function getAllUser()
    {
        return ArrayHelper::map(User::find()
            ...
            ->andWhere(['!=','user_type', User::PORT_STAFF])
            ->all(),
            'id','username');
    }
    ...
    {
        return ArrayHelper::map(User::find()
            ->where(['in','user_type',User::PORT_STAFF])
            ->andWhere(['branch'=>Yii::$app->user->identity->branch])
            ->all(),
            'id','username');
    }
