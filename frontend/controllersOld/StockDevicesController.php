...
use frontend\models\StockDevicesSearch;
                    ...
                    if ($selection != ''){
                        ...
                        foreach ($selection as $key => $value) {
                         //   StockDevices::updateAll(['status'=>StockDevices::available],['id' => $value]);
                            StockDevices::updateAll(['view_status'=>Devices::awaiting_receive],['id' => $value]);
                            AwaitingReceive::updateAll(['view_status'=>Devices::awaiting_receive],['id' => $value]);
...
//                            $stock->save();
                            ...
                            $stock->serial_no = $e['serial_no'];
                            $stock->border_port = $e['location_from'];
              ...
              foreach($selection as $id) {
                  ...
                  if ($action != '' && $points != ''){
                      ...
                      foreach ($selection as $key => $value) {
                          ...
                          $type = Devices::find()->where(['serial'=>$e['serial_no']])->one();
