...
<div class="application-search">
    ...
    <?php $form = ActiveForm::begin([
        'action' => ['awaiting-storage-search'],
        'method' => 'get',
    ...
    <div class="panel panel-warning" style="background: #EEE">
        ...
        <div id="collapse1" class="panel-collapse collapse">
            <div class="panel panel-body" style="background: #EEE">
                <div class="row">
                    <div class="col-md-3">
                        <?= $form->field($model, 'serial_no')->textarea(['id' => 'serial', 'rows' => 10, 'placeholder'=>'Enter serial number(s)']) ?>
                    </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <?php $form->field($model, 'border_port')->widget(Select2::classname(), [
                            'data' => \frontend\models\BorderPort::getBordersPorts(),
                    ...
                    <div class="form-group" style="float: right; padding-right: 8%;padding-top: 10px">
