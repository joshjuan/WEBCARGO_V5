...
<div class="received-devices-index" style="padding-top: 2%">
    ...
    ?>
    <?php echo $this->render('_searchDamaged', ['model' => $searchModel]); ?>
    <?= Html::beginForm(['damaged-to-await-storage'], 'post'); ?>
    <?php
...
//        ],
    ...
    echo \kartik\grid\GridView::widget([
        ...
        'panel' => [
            ...
            'heading' => 'List of damaged Devices',
            'before' => Yii::$app->user->can('damagedToAwaitingStorage') ?Html::submitButton('<i class="fa fa-check"></i>Send to Await storage', ['class' => 'btn btn-success', 'data' => [
        ...
        'exportConfig' => [
            GridView::EXCEL => [
                'filename' => Yii::t('app', 'damaged report-') . date('Y-m-d'),
                'showPageSummary' => true,
                'options' => [
                    'title' => 'Custom Title',
                    'subject' => 'PDF export',
