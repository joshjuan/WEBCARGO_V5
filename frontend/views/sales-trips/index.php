...
/* @var $searchModel frontend\models\SalesTripsSearch */
...
//        ],
        ...
        [
            'attribute' => 'scanned_status',
            'value' => function ($model) {
                if ($model->scanned_status == 1) {
                    return 'Scanned';
                } else {
                    return '';
                }
        ...
        [
            ...
            'format' => 'raw',
            'value' => function ($model) {
                return Html::a(Html::encode($model->tzl), ['view', 'id' => $model->id]);

            }
            //       'visible' => yii::$app->user->can('productSerial')||yii::$app->user->can('admin'),
        ],
//        [
//            'attribute' => 'branch',
//            'value' => 'branch0.name',
...
//        ],
        ...
        [
            ...
            'value' => function ($model) {
                if ($model->trip_status == 1) {
                    return 'NORMAL';
                } elseif ($model->trip_status == 2) {
                    return 'EDITED';
                } elseif ($model->trip_status == 3) {
                    return 'CANCELLED';
                }
            }
        ],
    ...
    DynaGrid::begin([
        ...
        'gridOptions' => [
            'rowOptions' => function ($model2) {
                if ($model2->cancelled_by != '') {
                    return ['style' => 'background-color:#ff4d4d;'];
                } elseif ($model2->edited_by != '' || $model2->edited_at != '') {
