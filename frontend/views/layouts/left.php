                            ...
                            [
                                ...
                                'items' => [
                                    [
                                        ...
                                        'url' => ['/user'],
                                        'visible' => Yii::$app->user->can('viewUsersList'),
                                    ],

                                    [
                                        'label' => 'Manage Permissions',
                                        'icon' => 'certificate text-green',
                                           'visible' => Yii::$app->user->can('viewUserPermissions'),
                                        'url' => ['/auth-item/index'],
                                    ],
                                    [
                                        'label' => 'Manage User Roles',
                                         'visible' => Yii::$app->user->can('viewUserRoles'),
                                        'icon' => 'certificate text-green',
                                        'url' => ['/role/index'],
                                    ],
                                    [
                                        ...
                                        'icon' => 'certificate text-green',
                                        'visible' => Yii::$app->user->can('viewUserBorderAllocated'),
                                        'url' => ['/border-port-user'],
                                    ],

                                    [
                                        'label' => 'Bill Customer',
                                        'visible' => Yii::$app->user->can('viewBillCustomer'),
                                        'icon' => 'certificate text-green',
