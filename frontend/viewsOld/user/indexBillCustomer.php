    ...
    <div class="row">
        <div class="col-md-6">
            <strong class="lead" style="color: #01214d;font-family: Tahoma"> <i class="fa fa-th-list text-blue"></i>
                SYSTEM USERS - Bill Customer Users</strong>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-2">
            ...
            <?php if (Yii::$app->user->can('createBillCustomerUser') || Yii::$app->user->can('admin')) { ?>
                <?= Html::a(Yii::t('app', '<i class="fa fa-user"></i> New User'), ['user/create-bill-customer'], ['class' => 'btn btn-primary waves-effect waves-light']) ?>
            <?php } ?>
            ...
            [
                ...
                'buttons' => [
                    'view' => function ($url, $model) {
                        $url = ['view-bill-customer', 'id' => $model->id];
