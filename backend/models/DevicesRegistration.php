...
class DevicesRegistration extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['serial_no'], 'required'],
            [['received_from', 'border_port', 'received_from_staff', 'received_by', 'created_by', 'device_from', 'stock_status', 'status', 'branch', 'type', 'device_category', 'released_by', 'released_to', 'transferred_from', 'transferred_to', 'transferred_by', 'sales_person', 'sale_id', 'view_status', 'partiner', 'registration_by'], 'integer'],
