...
/**
 * ReleasedDevicesReportSearch represents the model behind the search form of `frontend\models\ReleasedDevicesReport`.
 */
class ReleasedDevicesReportSearch extends ReleasedDevicesReport
{
    ...
    {
        return [
            [['id', 'released_by', 'branch','released_to', 'transferred_from', 'transferred_to', 'status'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query ->andFilterWhere(['between', 'DATE_FORMAT(released_date, "%Y-%m-%d")', $this->date_from, $this->date_to]);
        $query ->andFilterWhere(['branch'=>\Yii::$app->user->identity->branch]);
